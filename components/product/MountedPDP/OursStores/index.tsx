...
const OursStoresModal = ({ handleCloseModal, product }: OursStoresModalProps) => {
    ...
    return createPortal(
        <div class="fixed inset-0 flex items-center justify-center z-[19]">
            <div class="fixed inset-0 bg-[rgba(255,255,255,0.75)]" onClick={handleCloseModal}></div>
            <div class="fixed md:max-h-[550px] inset-0 flex flex-col bg-brand-secondary-50 z-20 w-full md:max-w-[496px] p-4 md:rounded-lg md:relative min-h-[264px] transition-all">
