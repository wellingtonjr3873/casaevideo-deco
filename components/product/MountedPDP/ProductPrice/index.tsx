...
function ProductPrice({ product }: Props) {
  ...
  const priceHtml = (
    ...
    >
      <span class="text-brand-secondary-600 body-regular line-through">
        de {formatPrice(listPrice, offers?.priceCurrency)}
      </span>

      <div class="body-regular text-neutral-900 flex items-end">
        <span class="h4-bold">{formatPrice(price, offers?.priceCurrency)}</span>
      ...
      <div class="text-brand-secondary-900 body-regular">
